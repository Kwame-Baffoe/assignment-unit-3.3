...
var stretchPositives = [];
var stretchNegatives = [];
var stretchZeroes = [];
for (var item of supplyChanges) {
  if (item > 0) {
    stretchPositives.push(item);
    } else if (item < 0) {
      stretchNegatives.push(item);
      } else {
        stretchZeroes.push(item);
        }
        }
